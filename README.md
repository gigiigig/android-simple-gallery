...
If you want change folder you can launch GallerActivuty passing to Intent
...
You can also select wich image open on activity start, passing to Intent an extras  
